...
/**
 * Created with us-parent -> me.j360.base.bean.
 * User: min_xu
 * Date: 2014/8/12
 * Time: 15:51
 * 说明：
...
public class Pager {
    ...
    public Pager(Integer pageNumber,Long pageSize) {
        super();
        this.pageNumber = pageNumber;
    ...
    private BaseEnum.OrderType orderType = BaseEnum.OrderType.desc;// 排序方式
